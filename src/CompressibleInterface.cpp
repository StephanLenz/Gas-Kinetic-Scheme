...
void CompressibleInterface::assembleFlux(double * MomentU, double * MomentV, double * MomentXi, double * a, double * b, double * A, double * timeCoefficients, double* prim, double tau)
{
    ...
    // ================================================================================================================================================
    double q = timeCoefficients[1] * ( ( Flux_2[3] + Flux_3[3] ) - prim[1] * ( Flux_2[1] + Flux_3[1] ) - prim[2] * ( Flux_2[2] + Flux_3[2] ) ) * this->area * prim[0];

    this->timeIntegratedFlux[3] += ( 1.0/this->fluidParam.Pr - 1.0 ) * q;
    // ================================================================================================================================================
