...
IncompressibleInterface::IncompressibleInterface(Cell* negCell, Cell* posCell, bool negAdd, bool posAdd, float2** nodes, FluidParameter fluidParam, BoundaryCondition* BC, double periodicLength)
    : Interface(negCell, posCell, negAdd, posAdd, nodes, fluidParam, BC, periodicLength)
{
}
